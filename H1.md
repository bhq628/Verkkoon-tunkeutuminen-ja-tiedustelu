...
Tiedonsiirto tapahtuu käyttäjän 10.0.2.15 ja palvelimen 34.107.243.93 välillä.  
Paketit 1 ja 3 sisältävät suojattuja TLS-dataa.  
Paketissa 2 palvelin kuittaa vastaanottaneensa paketin 1.  
Paketteja on vain 3 eli ei tarpeeksi näyttämään seuraavia vaiheita tai lopetusta.  
Tässä vaiheessa TCP-yhteys on silti auki.  
...
ChatGPT hyödynnetty terminaalien komennoissa ja avustuksena Wiresharkin käyttöliittymän tulkitsemisessa.  
