...
<br>
Tässä kaapatut paketit.  
Seuraavaksi nämä pitää vain suodattaa, jotta tästä saadaan tarvittavat tiedot.  
![](images/h2-kaap.png)  
Käyttämällä "http.request" suodattimiin suodatin muut tiedot, joita ei tässä tarvita.  
